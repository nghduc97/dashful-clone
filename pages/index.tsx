...
function IndexPage(props) {
  ...
  return (
    <div className="text-gray-900">
      ...
      <header className="pb-24 bg-purple-600 text-white">
        <div className="mx-auto max-w-6xl">
          <nav className="py-1 lg:py-2 flex items-center lg:justify-between text-white">
            <button onClick={() => setMenuOpen(true)} className="ml-4 sm:ml-8 p-2 lg:hidden text-xl opacity-65" type="button">☰</button>
            <h1 className="ml-4 lg:ml-0">
          ...
          <div className="lg:flex lg:flex-row">
            <div className="ml-4 mt-24 sm:ml-10 lg:ml-0 lg:flex lg:flex-col lg:justify-center">
              <div>
      ...
      <main>
        <section className="pb-12">
          ...
          <div className="mx-auto max-w-6xl youtube-container">
            <iframe width="1280" height="720" src="https://www.youtube.com/embed/D37RXZsdVm8" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
          </div>
        </section>
